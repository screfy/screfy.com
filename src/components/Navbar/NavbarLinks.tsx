	...
	return (
		<Tooltip.Provider delayDuration={0}>
			<Tooltip.Root>
				...
				<Tooltip.Portal>
					<Tooltip.Content
						className="hidden rounded-lg bg-gray-3 px-1.5 py-1 text-sm text-gray-11 shadow radix-state-closed:animate-tooltip-close radix-state-delayed-open:animate-tooltip-open md:block"
						side="bottom"
